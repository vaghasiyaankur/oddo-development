        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link {{ Request::routeIs(['amenity.index', 'amenityCategory.index']) ? 'active' : '' }}" href="#hotel_facilities" data-bs-toggle="collapse"
                    ...
                    <i class="ri-apps-2-line"></i> <span data-key="t-apps">Hotel Facilities</span>
                </a>
                <div class="collapse menu-dropdown" id="hotel_facilities">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a class="nav-link menu-link {{ Request::routeIs('amenity.index') ? 'submenu_active' : '' }}" href="#amenityList1" data-bs-toggle="collapse">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link {{ Request::routeIs('paymentGateway.index') ? 'active' : '' }}" href="{{ route('paymentGateway.index') }}">
                    <i class="ri-apps-2-line"></i> <span data-key="t-landing">Payment Gateway</span>
                </a>
            </li>
            <li class="nav-item">
