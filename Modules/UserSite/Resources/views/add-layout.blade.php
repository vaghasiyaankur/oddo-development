                    ...
                    <div class="col-lg-9">
                        <main class="layout-add">
                            <div class="pannel-heading">
                                ...
                                <h5 class="heading-fs-16 purple-dark">Tell us abourt your first room. After entering all the
                                    necessary info,you can fill in the details of your other room.</h5>
                            </div>
                            <div class="layout-add-room">
                                <div class="add-room-box mx-auto text-center w-75">
                                    ...
                                    <div class="another-c-details mt-4">
                                        ...
                                        @endphp
                                        <a href="{{ route('layout-pricing-form', ['id' => $hotel_id]) }}"
                                            class="btn another-c-d-btn w-25">Add Room</a>
                                    </div>
                                </div>
                            </div>
