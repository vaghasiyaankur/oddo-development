            ...
            <div class="share-section mb-5">
                <div class="drag-section justify-content-between flex-wrap">
                    <div class="d-flex align-items-center mb-3 mb-lg-0">
                        <img src="{{ @$hotel->mainPhoto->first()->photos ? asset('storage/' . @$hotel->mainPhoto->first()->photos) : asset('assets/images/default-image.png') }}"
                    ...
                    <div class="upload-delete-button-step d-flex justify-content-between flex-wrap">
                        @if ($hotel->photo)
                            ...
                            <a href="javascript:;"
                                class="white-button-step px-3 py-2 d-flex align-items-center me-2 albumBtn"
                                data-id="{{ $hotel->UUID }}">Albums</a>
                        ...
                        <a href="javascript:;"
                            class="white-button-step px-3 py-2 d-flex align-items-center propertyDelete"
                            data-value="{{ $hotel->UUID }}">Delete</a>
                        {{-- <a href="javascript:;" class="white-button-step px-3 py-2 d-flex align-items-center showCalendar" id="showCalendarBtn">Calendar</a> --}}
                        {{-- <button type="button" class="white-button-step px-3 py-2 d-flex align-items-center showCalendar" id="calendar" data-bs-toggle="modal" data-bs-target="#calendarcontentModal">
