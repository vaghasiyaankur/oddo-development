...
class PropertyController extends Controller
{
    ...
    public function facilities_add_update(Request $request)
    {
        ...
        $Hotel = Hotel::updateOrCreate(['UUID' => $hotel_id], [
            ...
            'breakfast' => $request->breakfast_select,
            'lunch' => $request->lunch_select,
            'dinner' => $request->dinner_select,
            'breakfast_type' => $request->breakfast_type_val,
            'lunch_type' => $request->lunch_type_val,
            'dinner_type' => $request->dinner_type_val,
