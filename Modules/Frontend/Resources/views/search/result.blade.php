    ...
    @if (count($hotels))
        @foreach ($hotels as $key => $hotel)
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="result-main-img result-swpier-img overflow-hidden">
                                ...
                                <div class="modal fade img-popup-slider" id="image_{{ $key }}" tabindex="-1"
                            ...
                            <div class="result-main-middle ps-md-0 ps-3 pe-md-0 pe-3">
                                <div class="result-main-middle-content">
                                    ...
                                    <div class="middle-content-location">
                                        <p class="mb-1"><img
                                                src="{{ asset('assets/images/icons/search-h-loaction.png') }}"><span
                                                class="loaction-text">{{ @$hotel->city->name }}
                                                {{ @$hotel->country_id ? ',' . $hotel->country->country_name : '' }}</span>
                                        </p>
                                    ...
                                    <div class="middle-content-review">
                                        <p class="m-0 review-text text-decoration-underline"><a href="#"
                                                data-bs-toggle="modal" data-bs-target="#reviewspopup">1024 reviews</a>
                                        </p>
                                        <!-------- Reviews Popup Start -------->
                                                                ...
                                                                <div class="popup-content-main">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="review-popup-img">
                                                                                    <img src="{{ asset('assets/images/reviews-popup-1.png') }}"
                                                                    ...
                                                                    <div class="popup-reviews-comment">
                                                                        <div class="popup-reviews-comment-inner">
                                                                            ...
                                                                            <div
                                                                                class="reviews-comment-text-main mt-4">
                                                                                <div class="row border-bottom mt-3">
                                                                                    <div
                                                                                        class="col-sm-1 col-2 text-center">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/review-popup-2.png') }}">
                                                                                    </div>
                                                                                ...
                                                                                <div class="row border-bottom mt-3">
                                                                                    <div
                                                                                        class="col-sm-1 col-2 text-center">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/review-popup-3.png') }}">
                                                                                    </div>
                                                                                    <div class="col-sm-8 col-9 p-0 ">
                                                                                        <div
                                                                                            class="reviews-comment-content">
                                    ...
                                    <div class="middle-content-box d-flex mb-3">
                                        <div class="middle-content-box-inner me-2">
                                            <a href="#"><img
                                                    src="{{ asset('assets/images/icons/search-r-time.png') }}"></a>
                                        </div>
                                        <div class="middle-content-box-inner me-2">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body py-sm-5 display-flex-items">
                                                            <div class="modal-body-img text-center">
                                                                <img src="{{ asset('assets/images/search-360.png') }}"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="middle-content-box-inner me-2">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#locationPopup"><img
                                                    src="{{ asset('assets/images/icons/search-h-loaction.png') }}"></a>
                                            <!-------- Location popup start -------->
                                            <div class="modal fade location-popup-main" id="locationPopup"
                                                data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-fullscreen modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body py-sm-5">
                                                            <div class="location-popup overflow-hidden">
                                                                <div class="location-popup-inner">
                                                                    <div
                                                                        class="location-popup-locat position-relative">
                                                                        ...
                                                                        <div class="loaction-dist-radius">
                                                                            <div class="dist-radius-innner">
                                                                                <div class="dist-radius-content">
                                                                                    ...
                                                                                    <div
                                                                                        class="dist-radius-rang pe-3 ps-3">
                                                                                        <input type="range"
                                                                                            class="form-range"
                                                                                            id="customRange1">
                                                                                    </div>
                                                                    ...
                                                                    <div class="loaction-popup-content-box">
                                                                        <div
                                                                            ...
                                                                            <div class="small-box-main d-flex">
                                                                                <div
                                                                                    ...
                                                                                    <div class="small-box-single-img ">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/location-popup-1.png') }}">
                                                                                    </div>
                                                                                    <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="small-box-single-img">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/location-popup-2.png') }}">
                                                                                    </div>
                                                                                    <div
                                                                                        class="small-box-text ps-2 pe-3">
                                                                                        <span>Plazas</span>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="small-box-single-img">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/location-popup-3.png') }}">
                                                                                    </div>
                                                                                    <div
                                                                                        class="small-box-text ps-2 pe-3">
                                                                                        <span> Parks </span>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="small-box-single-img">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/location-popup-4.png') }}">
                                                                                    </div>
                                                                                    <div
                                                                                        class="small-box-text ps-2 pe-3">
                                                                                        <span> Markets </span>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="small-box-single-img">
                                                                                        <img
                                                                                            src="assets/images/icons/locaion-5.png">
                                                                                    </div>
                                                                                    <div
                                                                                        class="small-box-text ps-2 pe-3">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="small-box-single-img">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/location-popup-6.png') }}">
                                                                                    </div>
                                                                                    <div
                                                                                        class="small-box-text ps-2 pe-3">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="small-box-single-img">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/icons/location-popup-7.png') }}">
                                                                                    </div>
                                                                                    <div
                                                                                        class="small-box-text ps-2 pe-3">
                                                                            ...
                                                                            <div
                                                                                class="loaction-popup-card d-flex mb-4">
                                                                                <div
                                                                                    class="location-popup-card-single ms-3 mt-4">
                                                                                    <div
                                                                                        class="card-single-head d-flex align-items-center bg-purple">
                                                                                        <div
                                                                                            class="card-head-img pe-3">
                                                                                            <img
                                                                                                src="{{ asset('assets/images/icons/locationpopup-card1.png') }}">
                                                                                        </div>
                                                                                        <div class="card-head-text">
                                                                                            Museums</div>
                                                                                    </div>
                                                                                    <div class="card-content">
                                                                                        <p class="mb-2">Museo del
                                                                                            Prado </p>
                                                                                        <p class="mb-2">
                                                                                            Thyssen-Bornemisza Museum
                                                                                        </p>
                                                                                        <p class="mb-2">Museo
                                                                                            Nacional Centro de Arte </p>
                                                                                        <p class="mb-2">Atocha
                                                                                            Headquarters (Sabatini and
                                                                                            Nouvel buildings)
                                                                                        </p>
                                                                                        <p class="mb-2">Palacio de
                                                                                            Velázquez (Retiro Park) </p>
                                                                                        <p class="mb-2">Palacio de
                                                                                            Cristal (Retiro Park) </p>
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="location-popup-card-single mt-4">
                                                                                    <div
                                                                                        class="card-single-head d-flex align-items-center bg-green">
                                                                                        <div
                                                                                            class="card-head-img pe-3">
                                                                                            <img
                                                                                                src="{{ asset('assets/images/icons/locationpopup-card2.png') }}">
                                                                                        </div>
                                                                                        <div class="card-head-text">
                                                                                            Parks</div>
                                                                                    </div>
                                                                                    <div class="card-content">
                                                                                        <p class="mb-2">Museum of
                                                                                            Entomology (UCM) </p>
                                                                                        <p class="mb-2">Hispanic
                                                                                            Pharmacy Museum (UCM)</p>
                                                                                        <p class="mb-2">Museum of
                                                                                            Geology (UCM)</p>
                                                                                        <p class="mb-2">Museum of
                                                                                            Dentistry "Luis de Macorra"
                                                                                            UCM</p>
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="location-popup-card-single mt-4">
                                                                                    <div
                                                                                        class="card-single-head d-flex align-items-center bg-green-two">
                                                                                        <div
                                                                                            class="card-head-img pe-3">
                                                                                            <img
                                                                                                src="{{ asset('assets/images/icons/locationpopup-card3.png') }}">
                                                                                        </div>
                                                                                        <div class="card-head-text">
                                                                                            Markets</div>
                                                                                    </div>
                                                                                ...
                                                                                <div
                                                                                    class="location-popup-card-single mt-4">
                                                                                    <div
                                                                                        class="card-single-head d-flex align-items-center bg-purple-2">
                                                                                        <div
                                                                                            class="card-head-img pe-3">
                                                                                            <img
                                                                                                src="{{ asset('assets/images/icons/locationpopup-card4.png') }}">
                                                                                        </div>
                                                                                        <div class="card-head-text">
                                                                                            Beaches</div>
                                                                                    </div>
                                            ...
                                            <div class="right-menu mb-2">
                                                <div class="right-menu-icon d-flex pb-1">
                                                    <div class="right-menu-icon-inner">
                                                        <img
                                                            src="{{ asset('assets/images/icons/search-i-1.png') }}">
                                                    </div>
                                                    <div class="right-menu-text"><a href="javascript:;"
                                                            class="para-d-l-p">Fábula
                                                            Taberna</a></div>
                                                </div>
                                            </div>
                                            <div class="right-menu mb-2">
                                                <div class="right-menu-icon d-flex pb-1">
                                                    <div class="right-menu-icon-inner">
                                                        <img
                                                            src="{{ asset('assets/images/icons/search-i-2.png') }}">
                                                    </div>
                                                    <div class="right-menu-text"><a href="javascript:;"
                                                            class="para-d-l-p">El Albero</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="right-menu mb-2">
                                                <div class="right-menu-icon d-flex pb-1">
                                                    <div class="right-menu-icon-inner">
                                                        <img
                                                            src="{{ asset('assets/images/icons/search-i-3.png') }}">
                                                    </div>
                                                    <div class="right-menu-text"><a href="javascript:;"
                                                            class="para-d-l-p">LePaste</a></div>
                                                </div>
                                            </div>
                                            <div class="right-menu mb-2">
                                                <div class="right-menu-icon d-flex pb-1">
                                                    <div class="right-menu-icon-inner">
                                                        <img
                                                            src="{{ asset('assets/images/icons/search-i-4.png') }}">
                                                    </div>
                                                    <div class="right-menu-text"><a href="javascript:;"
                                                            class="para-d-l-p"> Pf Changs</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="right-menu mb-2">
                                                <div class="right-menu-icon d-flex pb-1">
                                                    <div class="right-menu-icon-inner">
                                                        <img
                                                            src="{{ asset('assets/images/icons/search-i-5.png') }}">
                                                    </div>
                                                    <div class="right-menu-text"><a href="javascript:;"
                                                            class="para-d-l-p"> ATM Gran Via</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="right-menu mb-2">
                                                <div class="right-menu-icon d-flex pb-1">
                                                    <div class="right-menu-icon-inner">
                                                        <img
                                                            src="{{ asset('assets/images/icons/search-i-6.png') }}">
                                                    </div>
                                                    <div class="right-menu-text"><a href="javascript:;"
                                                            class="para-d-l-p"> Hotel V bar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="search-result-price-tag position-relative ">
                <button class="price-btn">$1.520 for 3 Nights</button>
            </div>
        @endforeach
    @else
