              ...
              <div class="result-main-middle-content">
                                  ...
                                  <div class="popup-reviews-comment-inner">
                                    ...
                                    <div class="reviews-comment-text-main mt-4">
                                      <div class="row border-bottom mt-3">
                                        <div class="col-sm-1 col-2 text-center"><img
                ...
                <div class="middle-content-box d-flex mb-3">
                  ...
                  <div class="middle-content-box-inner me-2">
                    ...
                    <!-------- view360 popup start --------->
                    <div class="modal fade" id="view360" data-bs-backdrop="static" data-bs-keyboard="false"
                  ...
                  <div class="middle-content-box-inner me-2">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-toggle="tooltip"
                      data-placement="top" title="Price Comparision"><img
                              ...
                              <div class="location-popup-inner">
                                <div class="location-popup-locat position-relative">
                                  ...
                                  <div class="location-popup-hilton">
                                    <img src="{{ asset('assets/images/icons/location-popup-L.png') }}" alt="">
                                  </div>
                ...
                <div class="right-menu-main mb-4">
                  <div class="right-menu-inner">
                    <div class="right-menu mb-2">
                      <div class="right-menu-icon d-flex pb-1">
                        <div class="right-menu-icon-inner">
                          <img src="{{ asset('assets/images/icons/search-i-1.png') }}">
                        </div>
                    ...
                    <div class="right-menu mb-2">
                      <div class="right-menu-icon d-flex pb-1">
                        <div class="right-menu-icon-inner">
                          <img src="{{ asset('assets/images/icons/search-i-2.png') }}">
                        </div>
                    ...
                    <div class="right-menu mb-2">
                      <div class="right-menu-icon d-flex pb-1">
                        <div class="right-menu-icon-inner">
                          <img src="{{ asset('assets/images/icons/search-i-3.png') }}">
                        </div>
                    ...
                    <div class="right-menu mb-2">
                      <div class="right-menu-icon d-flex pb-1">
                        <div class="right-menu-icon-inner">
                          <img src="{{ asset('assets/images/icons/search-i-4.png') }}">
                        </div>
                    ...
                    <div class="right-menu mb-2">
                      <div class="right-menu-icon d-flex pb-1">
                        <div class="right-menu-icon-inner">
                          <img src="{{ asset('assets/images/icons/search-i-5.png') }}">
                        </div>
                    ...
                    <div class="right-menu mb-2">
                      <div class="right-menu-icon d-flex pb-1">
                        <div class="right-menu-icon-inner">
                          <img src="{{ asset('assets/images/icons/search-i-6.png') }}">
                        </div>
