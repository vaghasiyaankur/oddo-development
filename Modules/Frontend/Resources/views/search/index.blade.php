            ...
            <div class=" row align-items-center">
              <div class="col-lg-6 mb-2">
                ...
                <div class="d-flex align-items-center search-input">
                  ...
                  <input type="text" name="search" id="autocomplete" class="form-control border-0" placeholder="Search Place" value="{{request()->search}}">
                ...
                <div class="hotels-filter result-mobile-view">
                  ...
                  <div class="hotels-result-property pt-4">
                    ...
                    <div class="form-check">
                      ...
                      <label class="property-class-icon ps-2" for="5-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon" for="5-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="5-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="5-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="5-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                    </div>
                    <div class="form-check">
                      ...
                      <label class="property-class-icon ps-2" for="4-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="4-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="4-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="4-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="3-star" checked>
                      <label class="property-class-icon ps-2" for="3-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="3-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="3-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="2-star">
                      <label class="property-class-icon ps-2" for="2-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                      <label class="property-class-icon " for="2-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="1-star">
                      <label class="property-class-icon ps-2" for="1-star"><img src="{{ asset('assets/images/icons/start.png') }}"></label>
                    </div>
                  </div>
                  ...
                  <div class="hotels-results-amenities pt-1">
                    ...
                    <div class="form-check">
                      ...
                      <span class="amenities-icon"><img src="{{ asset('assets/images/icons/amenties-1.png') }}" alt=""></span>
                    </div>
                    <div class="form-check">
                      ...
                      <span class="amenities-icon"><img src="{{ asset('assets/images/icons/amenities-2.png') }}" alt=""></span>
                    </div>
                    <div class="form-check">
                      ...
                      <span class="amenities-icon"><img src="{{ asset('assets/images/icons/amenities-3.png') }}" alt=""></span>
                    </div>
                    <div class="form-check">
                      ...
                      <span class="amenities-icon"><img src="{{ asset('assets/images/icons/amenities-4.png') }}" alt=""></span>
                    </div>
                    <div class="form-check">
                      ...
                      <span class="amenities-icon"><img src="{{ asset('assets/images/icons/amenities-5.png') }}" alt=""></span>
                    </div>
                  </div>
...
src='https://maps.googleapis.com/maps/api/js?libraries=places&v=3&language=En&key=AIzaSyBZhREk9TESs69r99eYGKkIQ725IqOP8Zc&ver=5.9.3'></script>
