...
<style>
    ...
    .hotel-result .side-content form#formReset {
        padding: 20px;
        position: relative;
    }
    .hotel-result .side-content .hotels-result-sort {
        background: rgb(106 120 199 / 5%);
        border-radius: 3px;
        padding: 20px;
        margin-top: 20px;
    }
    .hotel-result .side-content .hotels-result-budget {
        background: rgb(106 120 199 / 5%);
        border-radius: 3px;
        padding: 20px;
        margin-top: 20px;
    }
    .hotel-result .side-content .hotels-result-property {
        background: rgb(106 120 199 / 5%);
        border-radius: 3px;
        padding: 20px;
        margin-top: 20px;
    }
    .hotel-result .side-content .hotels-results-amenities {
        background: rgb(106 120 199 / 5%);
        border-radius: 3px;
        padding: 20px;
        margin-bottom: 30px;
    ...
    .hotel-result .side-content a.applyButton {
        background: #6a78c7;
        color: #fff;
        border: none;
        padding: 8px 24px;
    ...
    .hotel-result .side-content .apply_button_ {
        position: absolute;
        display: inline-flex;
        bottom: auto;
        margin-bottom: 0px;
                        ...
                        <form action="javascript: void(0);">
                            <div
                                ...
                                <div class="check-text-label col-sm-6  mb-4 pb-2">
                                    ...
                                    <div class="input--text d-flex align-items-center mt-2">
                                    ...
                                    <div class="form-check d-flex align-items-center">
                                        ...
                                        <label for="star_5">
                                            <span class="property-class-icon ps-2"><img
                                                    src="{{ asset('assets/images/icons/start.png') }}" width="14" height="14" alt="star"></span>
