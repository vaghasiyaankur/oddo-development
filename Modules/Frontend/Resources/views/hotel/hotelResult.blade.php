            ...
            <div class="result-main-middle-content">
              ...
              <div class="middle-content-location">
                <p class="mb-1"><img src="assets/images/icons/search-h-loaction.png"><span
                    ...
                    '.$hotel->country->country_name : ''}}</span></p>
              ...
              <div class="middle-content-box d-flex mb-3">
                ...
                <div class="middle-content-box-inner me-2">
                  <a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-toggle="tooltip"
                    data-placement="top" title="Price Comparision"><img src="assets/images/icons/search-doller.png"></a>
                                ...
                                <div class="loaction-popup-card d-flex mb-4">
                                  ...
                                  <div class="location-popup-card-single ms-3 mt-4">
                                    <div class="card-single-head d-flex align-items-center bg-purple" style="background-color: {{@$facilities->color}} !important;
                                                          color: white;">
                                      <div class="card-head-img pe-3"><i id="img-icon"
                                          class="{{ @$facilities->icon }}"></i></div>
