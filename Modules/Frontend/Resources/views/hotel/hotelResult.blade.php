                         ...
                         <div class="result-main-middle ps-md-0 ps-3 pe-md-0 pe-3">
                             <div class="result-main-middle-content">
                                 ...
                                 <div class="middle-content-location">
                                     <p class="mb-1"><img src="{{asset('assets/images/icons/search-h-loaction.png')}}" alt="location" width="10" height="12"><span
                                 ...
                                 <div class="middle-content-box d-flex mb-3">
                                     <div class="middle-content-box-inner me-2">
                                         <a href="#"><img src="{{ asset('assets/images/icons/search-r-time.png') }}" alt="search-time" width="15" height="16"></a>
                                     </div>
                                     <div class="middle-content-box-inner me-2">
       ...
       <div class="col-md-4">
         <div class="result-main-middle ps-md-0 ps-3 pe-md-0 pe-3">
           <div class="result-main-middle-content">
             ...
             <div class="middle-content-box d-flex mb-3">
               <div class="middle-content-box-inner me-2">
                 <a href="#"><img src="assets/images/icons/search-r-time.png" alt="search-time" width="15" height="16"></a>
               </div>
               <div class="middle-content-box-inner me-2">
                 <a href="#" data-bs-toggle="modal" data-bs-target="#view360"><img
