                                    ...
                                    <div class="col-md-3 col-sm-5">
                                        <div class="review-section">
                                            <div
                                                ...
                                                <span class="review-section-text bg-green">3/5</span>
                                            </div>
                                            <div
                                                class="review-section-total-review d-flex align-items-center justify-content-between mt-2">
                                                <span class="para-fs-14">Amenities</span>
                                                <span class="review-section-text bg-red">2/5</span>
                                            </div>
                                            <div
                                                class="review-section-total-review d-flex align-items-center justify-content-between mt-2">
                                                <span class="para-fs-14">Cleanless</span>
                                                <span class="review-section-text bg-orange">5/5</span>
                                            </div>
                                            <div
                                                class="review-section-total-review d-flex align-items-center justify-content-between mt-2">
                                                <span class="para-fs-14">Room</span>
                                                <span class="review-section-text bg-green">5/5</span>
                                            </div>
                                            <div
                                                class="review-section-total-review d-flex align-items-center justify-content-between mt-2">
                                                <span class="para-fs-14">Breakfast</span>
                                                <span class="review-section-text bg-red">3/5</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-5 p-sm-0 offset-sm-1">
                                        <div class="review-section">
                                            <div
                                                ...
                                                <span class="review-section-text bg-orange">4/5</span>
                                            </div>
                                            <div
                                                class="review-section-total-review d-flex align-items-center justify-content-between mt-2">
                                            ...
                                            <div
                                                ...
                                                <span class="para-fs-14">Price /
                                                    Quality</span>
                                                <span class="review-section-text bg-orange">2/5</span>
                                            </div>
                                            <div
                                                class="review-section-total-review d-flex align-items-center justify-content-between mt-2">
