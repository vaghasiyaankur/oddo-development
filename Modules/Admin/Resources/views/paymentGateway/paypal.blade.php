    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="form-check form-switch form-switch-success fs-5">
                <input class="form-check-input paypal_status" type="checkbox" role="switch" id="SwitchCheck3"  {{ $paymentGateways[0]['status'] == 1 ? "checked" : " " }}>
            </div>
        </div>
        ...
        <div class="card-body px-4">
            <form class="paypalForm" method="post" action="javascript:void(0):;">
                    ...
                    <div class="status-card d-flex align-items-center justify-content-between">
                        <div class="form-check card-radio w-100 me-4">
                            <input id="paypalMethod01" name="paypalMethod" type="radio"
                                class="form-check-input paypal_mode" value="test" {{$paymentGateways[0]['mode'] == 'test' ? 'checked' : '' }} data-value='{{ $paymentGateways[0]['payment_type'] }}'>
                        ...
                        <div class="form-check card-radio w-100">
                            <input id="paypalMethod02" name="paypalMethod" type="radio"
                                class="form-check-input paypal_mode" value="live" {{$paymentGateways[0]['mode'] == 'live' ? 'checked' : '' }}
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control paypal_id" value='{{ $paymentGateways[0]["mode"] == "test" ? $paymentGateways[0]["test_client_id"]  : $paymentGateways[0]["live_client_id"] }}'>
                    <span id="paypal_id_error" class="text-danger"></span>
                </div>
                <div class="form-group mb-2 ">
                    <label>Paypal Client Secret</label>
                    <input type="text" class="form-control paypal_key" value="{{ $paymentGateways[0]["mode"] == "test" ? $paymentGateways[0]["test_client_secret_key"]  : $paymentGateways[0]["live_client_secret_key"] }}">
                    <span id="paypal_key_error" class="text-danger"></span>
                </div>
                <div class="form-group">
                    <label>Paypal Signature</label>
                    <input type="text" class="form-control paypal_api_key" value="{{ $paymentGateways[0]["mode"] == "test" ? $paymentGateways[0]["test_api_secret_key"]  : $paymentGateways[0]["live_api_secret_key"] }}">
