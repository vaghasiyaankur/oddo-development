                                    ...
                                    <table class="table align-middle table-nowrap mb-0 ">
                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <tr class="tr_{{$amenityCategory->id}}">
                                                <th scope="row"><a href="#" class="fw-medium">{{$amenityCategory->id}}</a></th>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" data-amenitycategory = '{{$amenityCategory->id}}' class="link-success fs-17 pe-3 edit-amenityCategory"><i
            ...
            $.ajax({
                ...
                success: function (res) {
                    if(res.amenityCategories){
                        $('.tbody').append('<tr class="tr_'+res.amenityCategories.id+'"><th scope="row"><a href="#" class="fw-medium">'+res.amenityCategories.id+'</a></th><td>'+res.amenityCategories.category+'</td><td><div class="form-check form-switch"><input class="form-check-input" type="checkbox" role="switch id="SwitchCheck1" ></div></td><td> <a href="javascript:void(0);" class="link-success fs-17 pe-3"><i class="ri-edit-2-line"></i></a> <a href="javascript:void(0);" class="link-danger fs-17"><i class="ri-delete-bin-line"></i></a></td></tr>');
