                    ...
                    <form class="updateAmenityForm" method="post" action="javascript:void(0)">
                        ...
                        <div class="modal-select-icon mb-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control iconPicker selectedIcon" id="amenityIcon"
                            ...
                            <div class="active-deactive-input">
                                <div class="form-check form-check-inline form-radio-success me-1">
                                    ...
                                    <label class="form-check-label"><input class="form-check-input" type="radio"
                                            name="e_status" id="status_active" value="1"> Active</label>
                                </div>
                                <div class="form-check form-check-inline form-radio-danger">

                                    <label class="form-check-label"><input class="form-check-input" type="radio"
                                            name="e_status" id="status_deactive" value="0"> Deactive</label>
                                </div>
                            </div>
