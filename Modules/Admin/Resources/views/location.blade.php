                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-lg-1 ps-0">
                            <div class="live-preview">
                                <button type="button" class="btn btn-success text-nowrap" data-bs-toggle="modal" data-bs-target="#exampleModalgrid">
                                    Location Details
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="gallery-box edit-data-box card">
                                    <div class="edit-box">
                                        <span
                                            ...
                                            style="right:-14px;top: 36px;z-index:111;"><i class="ri-pencil-line"
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <div class="location-box">
                            <input type="text" class="form-control" id="exampleDropdownFormtext" placeholder="Enter City Name">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        {{-- <div class="form-check form-switch form-switch-custom form-switch-success">
                            ...
                            <label class="form-check-label" for="SwitchCheck11">Active / Deactive</label>
                        </div> --}}
