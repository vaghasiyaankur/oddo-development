            ...
            @foreach ($roomLists as $key => $room)
                <tr class="tr_{{ $room->id }}">
                    ...
                    <td>
                        ...
                        <div class="loadingHide">{{ $room->roomTypes->room_type }}</div>
                    </td>
                    <td>
                        <div class="loadingShow td-3">
                            <span></span>
                        ...
                        <div class="form-check form-switch loadingHide">
                            <input class="form-check-input roomStatus" data-value="{{ $room }}" type="checkbox"
                                role="switch" id="SwitchCheck1" {{ $room->status == 1 ? 'checked' : '' }}>
                        </div>
                    </td>
                    <td>
                        <div class="loadingShow td-3">
                        ...
                        <div class="loadingHide">
                            <a href="javascript:void(0);" class="link-success fs-17 pe-3 edit-room"
                                data-value="{{ $room }}"><i class="ri-edit-2-line"></i></a>
                            <a href="javascript:void(0);" class="link-danger fs-17 delete-room"
                                data-value="{{ $room->id }}"><i class="ri-delete-bin-line"></i></a>
                        </div>
                    </td>
                </tr>
            @endforeach
